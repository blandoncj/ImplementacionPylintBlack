...
class CookBookSchema(BaseModel):
    ...
    def validate_isbn(cls, isbn):
        ...
        Args:
            ...
            isbn (str): The ISBN to be validated.
        Raises:
            ValueError: If the ISBN is not a string of 10 digits.
        Returns:
            str: The validated ISBN.
        """

        if not isinstance(isbn, str) or not re.match(r"^[0-9]{10}$", isbn):
            raise ValueError("ISBN must be a string of 10 digits")
        return isbn
    ...
    def validate_description(cls, description):
        """
        Validates the description of a cookbook.
        Args:
            cls: The class object.
            description (str): The description to be validated.
        Raises:
            ValueError: If the description is not between 10 and 1000 characters long.
        Returns:
